...
The long form: how the interpreter is put together, what the
`.pyc` pipeline looks like, how dispatch works, and how to extend
it. For a quick tour, the CLI, and the performance table, start
