...
// htmlEntities maps the full HTML4 named character references (~253 entries).
// This covers everything in CPython's html.entities.name2codepoint.
var htmlEntities = map[string]string{
	// Full HTML4 named character references (~253 entries)
	"amp": "&", "lt": "<", "gt": ">", "quot": "\"",
	"apos": "'", "nbsp": "\u00a0", "iexcl": "\u00a1", "cent": "\u00a2",
